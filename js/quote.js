const quotes = [
  ...
  {
    quote:
      "It's easy to know what you're against, but quite another to know what you're for.",
    author: "- <The Wind That Shakes the Barley>",
  },
  {
  ...
  {
    quote:
      "진보를 믿지 않음으로써 그들이 비난하는 것은 미래가 아니라 그들 자신이다.",
    author: "- 빅토르 위고 《 레 미제라블 》",
  },
  {
    quote:
      "먼 곳에 있는 희미한 것을 바라보지 말고 당장 눈앞에 분명하게 보이는 것을 실천하라.",
    author: "- 토마스 칼라일",
  },
  {
